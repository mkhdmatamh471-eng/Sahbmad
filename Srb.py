...
EXCLUDE_KEYWORDS = [
   ...
   --- إضافة جديدة: استشارات طبية ونفسية ---
    "استشارات نفسية", "عن طريق الفيديو", "جلسة علاجية", "طبيب نفسي", "علاج سلوكي" 
...
"باسعار رمزيه", "بي اسعار رمزيه", "أسعار رمزية", 
    "لتواصل وتس", "للتواصل واتس", "وتس"
  ...
  # الصيغ التي طلبتها
    ...
    # --- إضافة جديدة: نداءات الإدارة والضرورة ---
    "احد من الاداره", "اكلم الاداره", "للضروره", "خاص للضرورة", "وين المشرف", "المشرفين  
